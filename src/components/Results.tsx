...
// Mock story data since this is a static site
const mockStory = {
  imageId: 1,
  content: "The figure appears deep in thought, perhaps contemplating an important decision or reflecting on past experiences. There's a sense of introspection and emotional depth in their posture.",
  demographics: {
...
export function Results() {
  const analysis = analyzeText(mockStory.content);
  ...
  const downloadPDF = () => {
    ...
    // Demographics
    if (mockStory.demographics) {
      doc.setFontSize(14);
      doc.text('Demographics:', 20, yPos);
      yPos += 10;
      doc.setFontSize(12);
      doc.text(`Gender: ${mockStory.demographics.gender}`, 30, yPos);
      yPos += 10;
      doc.text(`Age: ${mockStory.demographics.age}`, 30, yPos);
      yPos += 20;
    }
    ...
    yPos += 10;
    doc.setFontSize(12);
    const splitText = doc.splitTextToSize(mockStory.content, 170);
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="grid gap-8">
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <p className="text-gray-700 whitespace-pre-wrap">{mockStory.content}</p>
        </div>
